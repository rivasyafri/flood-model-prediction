...
public class Evapotranspiration {
     ...
     * @param cn air density in kg/m3
     * @param cd specific air heat in kJ/kg K
     ...
     * @param u2 wind speed in 2 m
     * @param tMean average of temperature
     * @param y psychometric constant in PaK
     * @return
     */
    public static double calculate(double rn, double g, double cn, double cd, double u2,
